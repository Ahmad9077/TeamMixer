...
- Setup (الإعداد): edit the five Arabic groups and members.
...
- `جلاد التنانين`: `assets/dragon-slayer.jpg`
...
- `جلاد التنانين`: `جراغ`, `الملا`, `طروق`
- `التنانين`: `حميد`, `البريجي`, `بوحمد`
- `الأسود`: `عليوي`, `الخلف`, `الهلالي`
- `الذئاب`: `حمود`, `مويس`, `قرطبة`
- `البطاريق`: `هشوم`
